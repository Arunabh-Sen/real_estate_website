...
const Testimonials = () => {
  return (
    ...
    className='container mx-auto py-10 lg:px-32 w-full overflow-hidden' id='Testimonials'>
        ...
        <p className='text-center text-gray-500 mb-12 max-w-80 mx-auto'>Real stories from those who found <br /> home with us</p>
        <div className='flex flex-wrap justify-center gap-8'>
            {testimonialsData.map((testimonial, idx) => (
                ...
                className='max-w-[340px] border shadow-lg rounded-lg px-8 py-12 text-center' key={idx}>
